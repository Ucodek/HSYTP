...
# Import models explicitly so they are registered with SQLAlchemy metadata
# These imports are needed for Alembic to detect models, even if unused in this file
# fmt: off
# ruff: noqa: F401
...
from app.models.historical import HistoricalData  # Add this import
